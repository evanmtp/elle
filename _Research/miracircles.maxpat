...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 1640.0, 122.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "zl slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 1460.0, 122.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "zl slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 1280.0, 122.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "zl slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 1094.0, 121.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "zl slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 916.0, 119.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "zl slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 740.0, 117.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "zl slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 550.0, 118.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "zl slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 369.0, 122.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "zl slice 2"
								}
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 199.0, 116.0, 0.0, 0.0 ],
									"style" : "",
									"text" : "zl slice 2"
								}
...
,
					"patching_rect" : [ 435.0, 435.0, 45.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.0, 330.0, 135.0, 90.0 ],
					"pinch_enabled" : 0,
					"rotate_enabled" : 0,
					"swipe_enabled" : 0,
					"swipe_touch_count" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 285.0, 330.0, 62.0, 22.0 ],
					"style" : "",
					"text" : "zl change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 285.0, 285.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "getattr dim"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 195.0, 510.0, 203.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 195.0, 435.0, 222.0, 22.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"code" : "circ(_st, _radius){\n    dist = norm-vec(0.5, 0.5);\n\treturn 1.-smoothstep(_radius-(_radius*0.01),\n                         _radius+(_radius*0.01),\n                         dot(dist,dist)*4.0);\n}\nst = norm;\ncolor = circ(norm,0.9);\r\nout1 = color;",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-9",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 420.0, 570.0, 390.0, 195.0 ],
									"presentation_rect" : [ 222.0, 312.0, 0.0, 0.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									"code" : "circ(uv, pos, rad, color) {\n\td = length(pos - uv) - rad;\n\tt = clamp(d, 0.0, 1.0);\n\treturn vec(1.0 - t);\n}\nParam c01 (0.8, 0.5);\r\nParam c03 (0.2, 0.5);\r\nParam c02 (0.2, 0.5);\r\nParam c04 (0.2, 0.5);\r\nParam c05 (0.2, 0.5);\r\nParam c06 (0.2, 0.5);\r\nParam c07 (0.2, 0.5);\r\nParam c08 (0.2, 0.5);\r\nParam c09 (0.2, 0.5);\r\nParam c10 (0.2, 0.5);\r\n\r\nParam t01 (0.);\r\nParam t02 (0.);\r\nParam t03 (0.);\r\nParam t04 (0.);\r\nParam t05 (0.);\r\nParam t06 (0.);\r\nParam t07 (0.);\r\nParam t08 (0.);\r\nParam t09 (0.);\r\nParam t10 (0.);\r\n\r\nParam rad (0.25);\r\n\r\nc01d = c01*dim.xy;\r\nc02d = c02*dim.xy;\nc03d = c03*dim.xy;\r\nc04d = c04*dim.xy;\r\nc05d = c05*dim.xy;\r\nc06d = c06*dim.xy;\r\nc07d = c07*dim.xy;\r\nc08d = c08*dim.xy;\r\nc09d = c09*dim.xy;\r\nc10d = c10*dim.xy;\r\n\r\nuv = cell;\n\r\ncenter = dim.xy * 0.5;\nradius = rad * dim.y;\n\n// Background layer\nlayer1 = vec(0, 0, 0, 1.0);\n\t\n// Circle\ncirc01 = circ(uv, c01d, radius, color);\ncirc02 = circ(uv, c02d, radius, color);\r\ncirc03 = circ(uv, c03d, radius, color);\r\ncirc04 = circ(uv, c04d, radius, color);\r\ncirc05 = circ(uv, c05d, radius, color);\r\ncirc06 = circ(uv, c06d, radius, color);\r\ncirc07 = circ(uv, c07d, radius, color);\r\ncirc08 = circ(uv, c08d, radius, color);\r\ncirc09 = circ(uv, c09d, radius, color);\r\ncirc10 = circ(uv, c10d, radius, color);\r\n\r\nout1 = circ01 * t01 + circ02 * t02\r\n\t+ circ03 * t03 + circ04 * t04\r\n\t+ circ05 * t05 + circ06 * t06\r\n\t+ circ07 * t07 + circ08 * t08\r\n\t+ circ09 * t09 + circ10 * t10;",
									"fontface" : 0,
									"fontname" : "Arial",
									"fontsize" : 12.0,
									"id" : "obj-3",
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 15.0, 45.0, 315.0, 405.0 ],
									"style" : ""
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 195.0, 285.0, 371.0, 22.0 ],
					"style" : "",
					"text" : "jit.world @fsmenubar 0 @fsaa 0 @high_res 1 @erase_color 0 0 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 435.0, 330.0, 129.406597, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 420.0, 150.0, 22.0 ],
					"style" : ""
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 380.5, 420.0, 204.5, 420.0 ],
					"order" : 1,
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 380.5, 317.0, 257.5, 317.0, 257.5, 274.0, 294.5, 274.0 ],
					"order" : 0,
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 249.5, 420.0, 204.5, 420.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 444.5, 468.0, 204.5, 468.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 318.5, 317.0, 261.5, 317.0, 261.5, 274.0, 204.5, 274.0 ],
					"source" : [ "obj-7", 1 ]
				}
